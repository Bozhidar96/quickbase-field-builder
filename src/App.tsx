...
const sortOptions: SelectOptionsType[] = [
    { id: sortTypes.alphaAscending, label: 'Display choices in Alphabetical' },
    { id: sortTypes.alphaDescending, label: 'Dispaly choices in Alphabetical' }
]
...
const App = (): JSX.Element => {
    ...
    useEffect(() => {
        const dataFromStorage = JSON.parse(getLocalStorage(storageKeyValue) ?? 'null')
